...
if(!function_exists('illdy_enqueue_stylesheets')) {
	...
	function illdy_enqueue_stylesheets() {
		...
		// WP Register Style
		wp_register_style( 'google-fonts', add_query_arg( $google_fonts_args, 'https://fonts.googleapis.com/css' ), array(), null );

		// WP Enqueue Style
		if( get_theme_mod( 'preloader_enable', 1 ) == 1 ) {
			wp_enqueue_style( 'pace', get_template_directory_uri() . '/layout/css/pace.min.css', array(), '', 'all' );
		}
 ...
 */
if(!function_exists('enqueue_javascripts')) {
	add_action( 'wp_enqueue_scripts', 'illdy_enqueue_javascripts' );

	function illdy_enqueue_javascripts() {
		if( get_theme_mod( 'preloader_enable', 1 ) == 1 ) {
			wp_enqueue_script( 'pace', get_template_directory_uri() . '/layout/js/pace/pace.min.js', array( 'jquery' ), '', false );
		}
		...
		wp_enqueue_script( 'owl-carousel', get_template_directory_uri() . '/layout/js/owl-carousel/owl-carousel.min.js', array( 'jquery' ), '2.0.0', true );
		wp_enqueue_script( 'count-to', get_template_directory_uri() . '/layout/js/count-to/count-to.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'visible', get_template_directory_uri() . '/layout/js/visible/visible.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'plugins', get_template_directory_uri() . '/layout/js/plugins.min.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'scripts', get_template_directory_uri() . '/layout/js/scripts.min.js', array( 'jquery' ), '', true );
		wp_enqueue_style ( 'bild', get_template_directory_uri() . '/layout/css/bild.scss',false,'1.1','all');
